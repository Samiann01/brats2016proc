...
\textit{lifting}. Furthermore, the proposed cost function induces a natural stopping condition to grow or prune decision trees, %, in contrast to more ad-hoc recipes based on depth or number of training samples. This results in 
